...
cat <<EOL > ./config/settings.json
{
    ...
    "_comment5": "You will need to fill the rank update channel and 4 rank or modify messageCreate.js in the events folder to add or remove rank roles",
    "INACTIVE_XP_CHANNELS": ["CHANNELS_ID"],
    "RANK_UPDATE_CHANNEL": "your-rank-update-channel-id",
    "RANK_UPDATE_ROLES": ["CHANNELS_ID"]
}
EOL
